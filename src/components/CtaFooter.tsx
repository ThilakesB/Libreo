  ...
  return (
    <section className="relative py-32 px-6 md:px-16 lg:px-24 text-center overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <p className="text-white/60 font-body font-light text-sm md:text-base max-w-xl mx-auto mb-8 leading-relaxed">
          We don't just build software.{" "}
          <br className="hidden sm:inline" />
          We give souls to software through creativity, purpose, and innovation.
        </p>
        <div className="flex items-center justify-center">
          <a
            href="https://github.com/Devfacticons"
            target="_blank"
            rel="noopener noreferrer"
            className="liquid-glass-strong rounded-full px-8 py-3.5 text-sm md:text-base font-medium text-white inline-flex items-center gap-2.5 hover:bg-white/10 hover:scale-[1.02] active:scale-[0.98] transition-all font-body cursor-pointer"
          >
            Join with us
        ...
        <div className="mt-32 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/40 font-body font-light text-xs">
            &copy; 2026 Libreo. All rights reserved.
          </p>
